...
create_daily_practice = wait.until(EC.element_to_be_clickable(
    (By.XPATH, "//button[contains(text(),'CREATE DAILY PRACTICE')]")
))
time.sleep(3)
...
# Practice Details...
wait = WebDriverWait(driver, 10)
type_dropdown = wait.until(EC.element_to_be_clickable((By.XPATH, "//label[text()='Type *']/following::div[@role='combobox'][1]")))
type_dropdown.click()
