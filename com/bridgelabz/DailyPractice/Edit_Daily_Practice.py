...
wait = WebDriverWait(driver, 10)
edit_practice_button = wait.until(EC.element_to_be_clickable((By.XPATH, "//button[@aria-label='edit']")))
edit_practice_button.click()
...
type_makerplan_option = wait.until(EC.element_to_be_clickable((By.XPATH, "//ul//li[contains(text(),'java programming')]")))
...
type_module_option=wait.until(EC.element_to_be_clickable((By.XPATH, "//ul//li[contains(text(),'oops programming')]")))
...
topic_name.click()
sleep(1)
topic_name_option=wait.until(EC.element_to_be_clickable((By.XPATH, "//ul//li[contains(text(),'Abstraction')]")))
topic_name_option.click()
sleep(1)

# day_input=driver.find_element(By.NAME, "day")
# day_input.send_keys("3")
day_input = driver.find_element(By.NAME, "day")
new_value = "3"
