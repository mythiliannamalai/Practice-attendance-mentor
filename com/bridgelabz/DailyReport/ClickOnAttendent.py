...
# Click the second row (you can also modify to click a specific button inside the row)
second_row = driver.find_element(By.XPATH, "//table/tbody/tr[1]")
second_row.click()
time.sleep(3)

wait = WebDriverWait(driver, 20)
close_lab = wait.until(EC.element_to_be_clickable(
